...
- Make sure to add [this Chrome's extension](https://chrome.google.com/webstore/detail/moesif-origin-cors-change/digfbfaphojjndkpccljibejjbppifbc) & have it on avoid [CORS](https://developer.mozilla.org/en-US/docs/Web/HTTP/CORS) issues.
